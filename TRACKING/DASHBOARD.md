...
| :-- | :-- | :-: | ---: | ---: | :-- | :-- | :-- |
| **M0** | [Walking Skeleton](M0_tracking.md) | ⬜ | 0/37 | 0/8 | — | — | `m0-skeleton` |
...
**Iterazione corrente:** — · **Prossima attività:** [M0 giorno 1](../SPECS/plan/M0_Walking_Skeleton.md#giorno-1--ambiente-e-infrastruttura-di-misura)
...
| 2 | TTFT | < 400 ms | — | M0, M7 | ⬜ |
| 3 | Throughput | ≥ 45 tok/s | — | M0, M7 | ⬜ |
| 4 | Picco VRAM | ≤ 7,2 GB | — | M0, M7 | ⬜ |
...
| **D3** | Inizio M6 | AEC necessario o superfluo | — | — |
